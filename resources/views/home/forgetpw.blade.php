...
<div class="resetpassword">
			<h3>密码重置<p id="rightP" style="width:150px;text-align:right; margin-top:-15px; *margin-top:-34px;">没有账号？<a href="/register">立即注册</a></p></h3>
			<form id="resetForm">
			<input type="hidden" class="token" value=""> 
				<p><em>*</em>手机号码<input type="text" id="phone" maxlength="11"><span id="firstSpan" style="display:none">请输入注册时填写的手机号</span></p>
				<p><em>*</em>手机确认<input type="text" id="checkPhone"><a href="javascript:void(0)" id="huoqu1" status="true">获取确认码</a><span id="checkback2" style="display:none"></span></p>
				...
				<a href="javascript:void(0)" status="true" id="resetpassword" class="resetbtn">确认重置</a>
