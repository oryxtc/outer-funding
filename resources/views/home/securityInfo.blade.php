...
<!--001-1-->
<div class="anniu"> <a class="btn-h01" id="validating" onclick="javascript:validateCard();">提&nbsp;交</a><a class="btn-h02" onclick="javascript:closeDiv(&#39;idcardDiv&#39;)">取&nbsp;消</a> </div>
</div>
</div>
...
<div class="con_i"><img src="./AmImages/security_no.png"></div>
</div>
...
<div class="con_ren"><a href="javascript:authcard();"><img src="./AmImages/security_1.png"></a></div>
</div>
</li>
</ul>
</div>
