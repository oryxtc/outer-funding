            ...
            <div class=" infBox">
                ...
                <div id="wjn_1" style="display:block;">
                    <div class="news">
                        <div class="t_news">
                            <ul>
                                <li><a href="/xiangqing/stock/{{$stock_data[0]->id}}" title="{{$stock_data[0]->title}}" target="_blank">{{$stock_data[0]->title}}</a></li>
                    ...
                    <div class="list_inf">
                        <ul>
                            @foreach($stock_data as $key=>$item)
                                @if($key>0)
                                    <li><a target="_blank" href="/xiangqing/stock/{{$item->id}}" class="&#39;s&#39;">{{$item->title}}</a><span>{{ \Carbon\Carbon::parse($item->created_at)->format('Y-m-d') }}</span></li>
                                @endif
                            @endforeach
                        </ul>
                    </div>
                ...
                <div class="infcon" id="wjn_2" style="display:none;">
                    <div class="news">
                        <div class="t_news">
                            <ul>
                                <li><a href="#/html/xhxw/gnyw/6039.html" title="全国部署夏季粮油收购工作 收购量预计将保持较高水平"
                                       target="_blank"> 全国部署夏季对夏季粮油收购工作做出全面部署安排粮油收购工作 收购量预计将保持较高水平 </a>
                                </li>
                                <span class="cc">国家粮食局、中国农业发展银行对夏季粮油收购工作做出全面部署安排、中国储备粮管理总公司日前在北京召开全国夏季粮油收购工作电视电安排。会议认...</span>
                            </ul>
                        </div>
                        <div class="clear"></div>下面没有文章了
                    <!--end news-->
                    <div class="list_inf">
                        <ul>
                            <li><a target="_blank" href="#/news/notice/t4013.html" class="&#39;s&#39;">家东阳企业组团参展义乌文交会买红木到东阳，29家东阳企业组团参展义乌文交会 </a></span>
                                <span>2017-05-02</span></li>
                            <li><a target="_blank" href="#/news/notice/t4013.html" class="&#39;s&#39;">家东阳企业组团参展义乌文交会买红木到东阳，29家东阳企业组团参展义乌文交会 </a></span>
                                <span>2017-05-02</span></li>
                            <li><a target="_blank" href="#/news/notice/t4013.html" class="&#39;s&#39;">家东阳企业组团参展义乌文交会买红木到东阳，29家东阳企业组团参展义乌文交会 </a></span>
                                <span>2017-05-02</span></li>
                            <li><a target="_blank" href="#/news/notice/t4013.html" class="&#39;s&#39;">买红木到东阳，29家东阳企业组团参展义乌文交会 </a></span>
                                <span>2017-05-02</span></li>
                        </ul>
                    </div>
                </div>
