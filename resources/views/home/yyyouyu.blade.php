...
<!--[if lt IE 9]><script src="scripts/IE9.js"></script> <![endif]-->
...
<div class="cp_m_titl">
<input class="font_size_22" id="tz" type="text" placeholder="1万元~600万元" onpaste="return false" autocomplete="off">
</div>
...
<input class="font_size_15" id="pzgg" name="lever" type="text" placeholder="1~5倍" onpaste="return false" autocomplete="off">
</div>
...
<div class="cp_m_ctn">
<div class="cp_m_num"><i>③</i>选择操盘月数<em style="font-size: 14px; color: #999">（1个月统一为30天，含节假日）</em></div>
<div class="cp_m_titl" style="height:0px">
<input class="font_size_15" type="hidden" id="use_day" name="borrowPeriod" placeholder="2~180天" onpaste="return false" autocomplete="off" value="">
</div>
...
<div class="cp_sider">
<div class="cp_m_num"><i>④</i>确认操盘规则<a href="#" target="_blank">今日限制股</a><a href="#" target="_blank" style="margin-right:20px;">当前风控等级</a></div>
<div class="cp_sdfont">
<label>操盘须知：</label>
...
<div class="cp_sdfont">
<label>总操盘费用：</label>
<span class=""><i id="lx"></i>元<strong style="margin-left: 14px; font-weight: 100;">一次性收取管理费用，中途终结方案不予退还，到期后自动延期一个月并扣除相应费用</strong></span> </div>
<div class="cp_sdfont">
<label>开始交易时间：</label>
<i class="cp_sd_time">
...
<span>我已阅读并同意<a href="javascript:tradeContract(1);">《月月操盘合作协议》</a><a href="javascript:tradeContract(2);">《风险提示书》</a></span> </div>
