...
<head>
    ...
    <title>配资网后台管理系统 {{ Voyager::setting("title") }}</title>
                ...
                <div class="col-sm-12 col-md-10 col-md-offset-2">
                    <div class="logo-title-container">
                        ...
                        <div class="copy animated fadeIn">
                            <h1>{{ Voyager::setting('admin_title', '配资网后台管理系统') }}</h1>
                            <p>{{ Voyager::setting('admin_description', '欢迎登录配资网后台管理系统') }}</p>
                        </div>
        ...
        <div class="col-xs-12 col-sm-4 col-md-3 login-sidebar animated fadeInRightBig">
            ...
            <div class="login-container animated fadeInRightBig">
                ...
                <div class="group">      
                  ...
                  <span class="bar"></span>
                  <label><i class="glyphicon glyphicon-user"></i><span class="span-input"> 用户名</span></label>
                </div>
