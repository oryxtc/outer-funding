...
<title>哎呀…您访问的页面不存在_上海妇产医院_上海百佳妇产医院</title>
<style>
*{margin:0;padding:0}
...
a{tex-decoration:none;outline:none}
...
.c1 .img1{margin-top:245px}
.c1 .img2{margin-top:165px}
.cont h2{text-align:center;color:#555;font-size:20px;font-weight:normal;height:35px}
.c2{height:35px;text-align:center;padding-top:40px;}
...
.c3{height:180px;text-align:center;color:#999;font-size:16px;padding-top:40px;}
...
<div class="bg">
	<div class="cont">
		...
		<h2>哎呀,404啦…您访问的页面不存在</h2>
		<div class="c2"><a href="javascript:history.go(-1);" class="re">返回上页</a><a href="/" class="home">网站首页</a><a href="/zt/swcc/" class="sr">搜索一下页面相关信息</a></div>
		<div class="c3"><a href="/" class="c3">上海百佳妇产医院</a>提醒您 - 您可能输入了错误的网址，或者该网页已删除或移动</div>
	</div>
</div>
</body>
</html>